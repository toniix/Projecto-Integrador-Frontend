...
import { Trash2, Edit } from "lucide-react"; // Importamos también el icono Edit
...
export const ListProduct = () => {
    ...
    return (
        <div className="p-6 bg-[#e6d1bb] rounded-lg shadow-lg">
            ...
            <div className="overflow-x-auto"> {/* Corregido de <di> a <div> */}
                            ...
                            products.map((product) => (
                                <tr key={product.idProduct} className="border-b border-[#a37b63] hover:bg-[#c6bcb049] transition">
                                    ...
                                    <td className="p-3 flex justify-center gap-2">
                                        {/* Botón de editar (invertimos colores) */}
                                        <button className="flex items-center justify-center text-[#730f06] bg-[#e6d1bb] hover:bg-[#d9c6b0] py-1 px-2 rounded transition w-10 h-10 border border-[#730f06]">
                                            <Edit size={18} />
                                        </button>
                                        
                                        {/* Botón de eliminar (invertimos colores) */}
                                        <button
                                            onClick={() => {
