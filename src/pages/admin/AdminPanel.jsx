  ...
  const refreshData = async () => {
    ...
    try {
      ...
      setStats({
        ...
        reservations: String(
          parseInt(stats.reservations) + randomChange(-3, 8)
        ),
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1e1e1e]/80 p-6">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm w-full text-center">
            ...
            <p className="text-[#757575] mb-4">
              El panel de administración está diseñado para verse en pantallas
              más grandes.
            </p>
      ...
      <div className="min-h-screen flex bg-[#F9F7F4] text-[#1e1e1e] pt-24 admin-background">
        {/* Menú Lateral Fijo */}
        <aside className="fixed w-[280px] h-[calc(100vh-96px)] bg-[#3B0012] text-white p-6 flex flex-col gap-4 shadow-lg admin-sidebar overflow-y-auto">
          <div className="flex items-center justify-center space-x-3 mb-8 border-b border-[#b08562] pb-4">
            ...
            <h3 className="text-xl font-bold text-[#d9c6b0] font-['Alata']">
              Admin Panel
            </h3>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 transition-all duration-300 hover:shadow-lg">
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-[#757575]">
                  Módulo de gestión de reservas en desarrollo.
                </p>
